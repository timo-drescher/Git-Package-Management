...
class Create extends Operation
{
    ...
    public function execute(string $dir, array $generalData, bool $withComposer = false, bool $force = false): void
    {
        ...
        $config = \GPM\Config\Config::load($this->modx, $this->logger, ['general' => $generalData, 'paths' => ['package' => $packagesDir . $dir . DIRECTORY_SEPARATOR], 'build' => [], 'database' => [], 'install' => [], 'update' => []]);
